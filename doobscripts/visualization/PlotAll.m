...
switch DataSet
    case 'PIOD'
        img_dir = '/data/DOOB/data/PIOD/JPEGImages/';
        gt_mat_dir = '/data/DOOB/data/PIOD/Data/';
        res_mat_dir = '../../results/PIOD/';
        export_dir = '../../results/figs/PIOD/';    
        test_ids_filename = '/data/DOOB/data/PIOD/val_doc_2010.txt';

        
    case 'BSDSownership'
        img_dir = '/data/DOOB/BSDSownership/BSDS300/images/train/';
        gt_mat_dir = '/data/DOOB/data/BSDSownership/testfg/';
        res_mat_dir = '../../results/BSDSownership/';
        export_dir = '../../results/figs/BSDSownership/';
        test_ids_filename = '/data/DOOB/data/BSDSownership/Augmentation/test_ori_iids.lst';
