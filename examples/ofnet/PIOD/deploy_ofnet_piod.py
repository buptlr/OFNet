...
data_root = '/data/OF/data/PIOD/Augmentation/'
save_root = '../Output/OFNet/PIOD/'
model = '../ofnet_piod.caffemodel'

deploy_prototxt = 'deploy_ofnet_piod.prototxt'
...
for idx in range(0, len(test_lst)):
    ...
    # print(os.path.split(test_lst[idx])[1].split('.')[0])
    net.forward()
